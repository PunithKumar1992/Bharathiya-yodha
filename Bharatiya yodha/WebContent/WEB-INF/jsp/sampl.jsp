        ...
        <c:param name="article_id" value="${comment.article.article_id}"></c:param>
      	<c:param name="comment_id" value="${comment.comment_id}"></c:param>
						...
						<div class="media-body response-text-right" style="margin-top: 5%;">
							...
							<c:if test="${not empty reply1.replayer_msg}">
							<div class="media response-info">
								<div class="media-left response-text-left">
									<a href="#">
										<img class="media-object" src="images/person.png" alt=""/>
									</a>
									<h5><a href="" >${reply1.replayer_name}</a></h5>
								</div>
								<div class="media-body response-text-right">
									<p>${reply1.replayer_msg}</p>
									<ul>
										<li>July 17, 2015</li>
										<li><a href="" onclick="showmd('${replay1}');">Reply</a></li>
									</ul>		
