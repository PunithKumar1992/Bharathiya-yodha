            ...
            <div class="col-md-12" id="bannerbanner">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div >
                                <form:form method="post" modelAttribute="banneredit" action="saveadmineditbanner.html" enctype="multipart/form-data">
                               <form:hidden path="banner_id"/>
                               <input type="hidden" name="banimgtoedit" value="${banimgtoedit}">
